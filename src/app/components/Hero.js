        ...
        <div className="flex flex-col xl:flex-row justify-center items-center xl:justify-start h-full">
          ...
          <div className="text-center xl:max-w-xl xl:text-left mt-16 xl:mt-0">
            <motion.h1
              ...
              className="h1"
            >
              Georgia Wholesaler & <span className="text-orange-500">Auto</span>{" "}
              Dealer{" "}
            </motion.h1>
            <motion.p
            ...
            >
              We buy cars from all over the United States and pay cash on sight
              for the DMV and Tri-state area of NY.
            </motion.p>
            {/* btns */}
          </div>
          {/* img car*/}
