...
export default function Footer() {
  return (
    <footer className="pt-20 bg-black z-20" id="contact">
      <div className="container mx-auto mb-24">
        ...
        >
          ...
          <div className="flex-1 text-white">
            ...
            {/* phone & email */}
            <div className="flex flex-col gap-y-4 font-semibold pt-4">
              {/* phone */}
              ...
              <div className="text-white flex items-center gap-x-[10px]">
                <FaEnvelope />
                <div className="font-medium">office@marrs.com</div>
              </div>
            </div>
          </div>
          {/* newsletter */}
          <div className="flex-1">
            <h3 className="h3 font-bold mb-8 text-white">Newsletter</h3>
            ...
            <form className="flex gap-x-2 h-14">
              ...
              />
              <button type="submit" className="btn btn-sm btn-orange w-24">
                Submit
              </button>
            </form>
          </div>
